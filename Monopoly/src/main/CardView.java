...
public class CardView extends JPanel {
	...
	public CardView( Space currentSpace ) {
		...
		add(lblWithHouse, gbc_lblWithHouse);
		...
		add(lblWith2Houses, gbc_lblWithHouses);
		...
		add(lblWith3Houses, gbc_lblWithHouses_1);
		...
		add(lblWith4Houses, gbc_lblWithHouses_2);
		...
		add(lblWithHotel, gbc_lblWithHotel);
		...
		add(lblHousesCost, gbc_lblHousesCost);
		...
		add(houseCostVal, gbc_houseCostVal);
		...
		add(lblHotelCost, gbc_lblNewLabel_1);
		...
		add(hotelCostVal, gbc_hotelCostVal);
		...
		add(lblWithRailroads, gbc_lblWithRailroads);
		...
		add(railRoad2Val, gbc_railRoad2Val);
		...
		add(lblWithRailroads_1, gbc_lblWithRailroads_1);
		...
		add(railRoad3Val, gbc_railRoad3Val);
		...
		add(lblWithRailroads_2, gbc_lblWithRailroads_2);
		...
		add(railRoad4Val, gbc_railRoad4Val);
		...
		gbc_cardDescription.insets = new Insets(0, 0, 5, 5);
		gbc_cardDescription.gridx = 1;
		gbc_cardDescription.gridy = 14;
		gbc_cardDescription.gridwidth = 3;
		add(cardDescription, gbc_cardDescription);
		...
		add(lblMortgageValue, gbc_lblMortgageValue);
		...
		add(mortgageVal, gbc_mortgageVal);
		...
		gbc_okayButton.insets = new Insets(0, 0, 5, 5);
		gbc_okayButton.gridx = 1;
		gbc_okayButton.gridy = 17;
		gbc_okayButton.gridwidth = 3;
		add(okayButton, gbc_okayButton);
